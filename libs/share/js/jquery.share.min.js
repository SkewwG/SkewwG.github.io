! function(r) {
	...
	function n(r, t, e) {
		s(e.background)
			.is("img") ? t.drawImage(e.background, 0, 0, e.size, e.size) : e.background && (t.fillStyle = e.background, t.fillRect(e.left, e.top, e.size, e.size));
		var n = e.mode;
	...
	function c(r) {
		return l && "canvas" === r.render ? f(r) : l && "image" === r.render ? function(r) {
			...
			for (a && d.css("background-color", a), n = 0; f > n; n += 1)
				for (o = 0; f > o; o += 1) t.isDark(n, o) && s("<div/>")
					.css(g)
					.css({
						left: l + o * c,
						top: l + n * c
	...
	s.fn.qrcode = function(r) {
		...
		return this.each(function() {
			"canvas" === this.nodeName.toLowerCase() ? u(this, t) : s(this)
				.append(c(t))
		})
	}
}(function() {
	...
	r.fn.share = function(t) {
		function e(t, e) {
			var n = function(t) {
				...
				var e = (r(window)
						.width() <= 768 ? t.mobileSites : t.sites.length ? t.sites : [])
					.slice(0),
					n = t.disabled;
		...
		var n = r(document.head),
			o = {
				...
				source: n.find("[name=site], [name=Site]")
					.attr("content") || document.title,
				title: n.find("[name=title], [name=Title]")
					.attr("content") || document.title,
				description: n.find("[name=description], [name=Description]")
					.attr("content") || "",
				image: r("img:first")
					.prop("src") || "",
		...
		this.each(function() {
			...
			var t = r.extend({}, i, r(this)
				.data());
			t.imageSelector && (t.image = r(t.imageSelector)
				.map(function() {
					return r(this)
						.prop("src")
				})
			...
			e(n, t),
				function(r, t) {
					...
					e.length && (e.append('<div class="wechat-qrcode"><h4>' + t.wechatQrcodeTitle + '</h4><div class="qrcode"></div><div class="help">' + t.wechatQrcodeHelper + "</div></div>"), e.find(".qrcode")
						.qrcode({
							render: "image",
		...
		r(".share-component,.social-share")
			.share()
	})
}(jQuery);