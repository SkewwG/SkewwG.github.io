...
! function() {
	...
	function D(t, e) {
		for (var r, i, n = 1, o = (r = t, (i = encodeURI(r)
				.toString()
				.replace(/\%[0-9a-fA-F]{2}/g, "a"))
			.length + (i.length != r ? 3 : 0)), a = 0, s = _.length; a <= s; a++) {
			var h = 0;
			switch (e) {
				case l.L:
					h = _[a][0];
...
function(r, o, h) {
	...
	function v(t) {
		return (o.getElementsByName(t)[0] || 0)
			.content
	}
	...
	r.socialShare = function(t, e) {
		(t = "string" == typeof t ? m(t) : t)
		.length === h && (t = [t]), C(t, function(t) {
			t.initialized || function(t, e) {
				...
				r.imageSelector && (r.image = m(r.imageSelector)
					.map(function(t) {
						return t.src
					})
					.join("||"));
				(function(t, e) {
					if (e && "string" == typeof e) {
						...
						var n, o, e = (n = t, (o = a)
								.summary || (o.summary = o.description), p[n].replace(/\{\{(\w)(\w*)\}\}/g, function(t, e, r) {
									var i = n + e + r.toLowerCase();
									return r = (e + r)
										.toLowerCase(), encodeURIComponent((o[i] === h ? o[r] : o[i]) || "")
								})),
